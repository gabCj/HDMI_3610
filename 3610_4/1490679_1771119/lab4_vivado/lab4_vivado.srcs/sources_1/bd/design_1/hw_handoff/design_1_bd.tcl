...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net sobel_filter_0_m_axi_gmem0 [get_bd_intf_pins axi_smc/S00_AXI] [get_bd_intf_pins sobel_filter_0/m_axi_gmem0]
  connect_bd_intf_net -intf_net sobel_filter_0_m_axi_gmem1 [get_bd_intf_pins axi_smc_1/S00_AXI] [get_bd_intf_pins sobel_filter_0/m_axi_gmem1]
  ...
  # Create port connections
  connect_bd_net -net axi4s_clk_1 [get_bd_pins axi_smc/aclk1] [get_bd_pins axi_smc_1/aclk1] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK] [get_bd_pins zed_hdmi_display/axi4s_clk]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK3 [get_bd_pins axi_smc/aclk] [get_bd_pins axi_smc_1/aclk] [get_bd_pins processing_system7_0/FCLK_CLK3] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins sobel_filter_0/ap_clk]
  ...
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces sobel_filter_0/Data_m_axi_gmem0] [get_bd_addr_segs processing_system7_0/S_AXI_HP1/HP1_DDR_LOWOCM] SEG_processing_system7_0_HP1_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces sobel_filter_0/Data_m_axi_gmem1] [get_bd_addr_segs processing_system7_0/S_AXI_HP2/HP2_DDR_LOWOCM] SEG_processing_system7_0_HP2_DDR_LOWOCM
