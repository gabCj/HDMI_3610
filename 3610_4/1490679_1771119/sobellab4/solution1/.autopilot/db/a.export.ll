...
; <label>:2                                       ; preds = %1
  ...
  %tmp_1 = zext i21 %i to i64
  %inter_pix_addr = getelementptr [2073600 x i8]* %inter_pix, i64 0, i64 %tmp_1
  %val = load i8* %inter_pix_addr, align 1
  %fourWide = call i32 @_ssdm_op_BitConcatenate.i32.i8.i8.i8.i8(i8 %val, i8 %val, i8 %val, i8 %val)
  %out_pix_addr = getelementptr [2073600 x i32]* %out_pix, i64 0, i64 %tmp_1
  store i32 %fourWide, i32* %out_pix_addr, align 4
  %empty_2 = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @p_str1, i32 %tmp_2) nounwind
  br label %1
