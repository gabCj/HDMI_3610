; ModuleID = 'X:/Bureau/3610_4/1490679_1771119/sobellab4/solution1/.autopilot/db/a.g.1.bc'
...
define void @sobel_filter(i8* %inter_pix, i32* %out_pix) nounwind uwtable {
  ...
  %fourWide.addr = getelementptr inbounds %union.OneToFourPixels.0* %fourWide, i64 0, i32 0, !dbg !45 ; [#uses=1 type=i32*] [debug line = 51:3]
...
; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !47 ; [debug line = 45:45]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !47 ; [#uses=1 type=i32] [debug line = 45:45]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !48 ; [debug line = 46:1]
  %tmp.1 = sext i32 %i to i64, !dbg !49           ; [#uses=2 type=i64] [debug line = 47:28]
  %inter_pix.addr = getelementptr inbounds i8* %inter_pix, i64 %tmp.1, !dbg !49 ; [#uses=1 type=i8*] [debug line = 47:28]
...
; <label>:4                                       ; preds = %3
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([7 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !40 ; [debug line = 50:4]
  %rbegin2 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([7 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !40 ; [#uses=1 type=i32] [debug line = 50:4]
  %tmp.3 = sext i32 %j to i64, !dbg !40           ; [#uses=1 type=i64] [debug line = 50:4]
  %tmp.addr = getelementptr inbounds [4 x i8]* %tmp, i64 0, i64 %tmp.3, !dbg !40 ; [#uses=1 type=i8*] [debug line = 50:4]
  store i8 %val, i8* %tmp.addr, align 1, !dbg !40 ; [debug line = 50:4]
  %rend3 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([7 x i8]* @.str2, i64 0, i64 0), i32 %rbegin2) nounwind, !dbg !66 ; [#uses=0 type=i32] [debug line = 50:22]
...
; <label>:5                                       ; preds = %3
  ...
  %out_pix.addr = getelementptr inbounds i32* %out_pix, i64 %tmp.1, !dbg !45 ; [#uses=1 type=i32*] [debug line = 51:3]
  store i32 %fourWide.load, i32* %out_pix.addr, align 4, !dbg !45 ; [debug line = 51:3]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str1, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !69 ; [#uses=0 type=i32] [debug line = 52:2]
...
!63 = metadata !{i32 786447, i32 0, metadata !"", i32 0, i32 0, i64 64, i64 64, i64 0, i32 64, metadata !53} ; [ DW_TAG_pointer_type ]
