...
; [#uses=0]
define void @sobel_filter([2073600 x i8]* nocapture %inter_pix, [2073600 x i32]* nocapture %out_pix) nounwind uwtable readnone {
...
; <label>:1                                       ; preds = %7, %0
  %i = phi i2 [ 0, %0 ], [ %i.1, %7 ]             ; [#uses=2 type=i2]
  %tmp = icmp eq i2 %i, -2, !dbg !79              ; [#uses=1 type=i1] [debug line = 109:40]
...
; <label>:4                                       ; preds = %branch4, %3
  %j = phi i11 [ 0, %3 ], [ %j.1, %branch4 ]      ; [#uses=2 type=i11]
  %tmp.4 = icmp eq i11 %j, -128, !dbg !85         ; [#uses=1 type=i1] [debug line = 110:41]
...
branch4:                                          ; preds = %4
  ...
  %j.1 = add i11 %j, 1, !dbg !92                  ; [#uses=1 type=i11] [debug line = 110:53]
  call void @llvm.dbg.value(metadata !{i11 %j.1}, i64 0, metadata !93), !dbg !92 ; [debug line = 110:53] [debug variable = j]
...
; <label>:7                                       ; preds = %4
  ...
  %i.1 = add i2 %i, 1, !dbg !95                   ; [#uses=1 type=i2] [debug line = 109:49]
  call void @llvm.dbg.value(metadata !{i2 %i.1}, i64 0, metadata !96), !dbg !95 ; [debug line = 109:49] [debug variable = i]
  br label %1, !dbg !95                           ; [debug line = 109:49]

.preheader:                                       ; preds = %14, %.preheader.preheader
  %i1 = phi i11 [ %i.2, %14 ], [ 0, %.preheader.preheader ] ; [#uses=2 type=i11]
  %tmp.3 = icmp eq i11 %i1, -968, !dbg !81        ; [#uses=1 type=i1] [debug line = 118:38]
...
; <label>:11                                      ; preds = %._crit_edge, %10
  %j2 = phi i11 [ 0, %10 ], [ %j.2, %._crit_edge ] ; [#uses=2 type=i11]
  %tmp. = icmp eq i11 %j2, -128, !dbg !99         ; [#uses=1 type=i1] [debug line = 119:39]
...
._crit_edge:                                      ; preds = %11
  ...
  %j.2 = add i11 %j2, 1, !dbg !106                ; [#uses=1 type=i11] [debug line = 119:51]
  call void @llvm.dbg.value(metadata !{i11 %j.2}, i64 0, metadata !107), !dbg !106 ; [debug line = 119:51] [debug variable = j]
...
; <label>:14                                      ; preds = %11
  ...
  %i.2 = add i11 %i1, 1, !dbg !109                ; [#uses=1 type=i11] [debug line = 118:50]
  call void @llvm.dbg.value(metadata !{i11 %i.2}, i64 0, metadata !110), !dbg !109 ; [debug line = 118:50] [debug variable = i]
