; ModuleID = 'X:/Bureau/3610_4/1490679_1771119/sobellab4/solution1/.autopilot/db/a.o.2.bc'
...
; <label>:3                                       ; preds = %1
  ...
  %tmp.2 = call i32 (...)* @_ssdm_op_SpecRegionBegin([4 x i8]* @.str1) nounwind, !dbg !54 ; [#uses=1 type=i32] [debug line = 45:45]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @.str) nounwind, !dbg !56 ; [debug line = 46:1]
  %tmp.1 = zext i21 %i to i64, !dbg !57           ; [#uses=2 type=i64] [debug line = 47:28]
  %inter_pix.addr = getelementptr [2073600 x i8]* %inter_pix, i64 0, i64 %tmp.1, !dbg !57 ; [#uses=1 type=i8*] [debug line = 47:28]
  ...
  %tmp.3 = call i24 @_ssdm_op_BitConcatenate.i24.i16.i8(i16 0, i8 %val) ; [#uses=1 type=i24]
  %tmp.4 = or i24 %tmp.3, %tmp1                   ; [#uses=1 type=i24]
  %fourWide = call i32 @_ssdm_op_BitConcatenate.i32.i8.i24(i8 %val, i24 %tmp.4), !dbg !59 ; [#uses=1 type=i32] [debug line = 50:4]
  call void @llvm.dbg.value(metadata !{i32 %fourWide}, i64 0, metadata !62), !dbg !59 ; [debug line = 50:4] [debug variable = fourWide]
  %out_pix.addr = getelementptr [2073600 x i32]* %out_pix, i64 0, i64 %tmp.1, !dbg !76 ; [#uses=1 type=i32*] [debug line = 51:3]
  store i32 %fourWide, i32* %out_pix.addr, align 4, !dbg !76 ; [debug line = 51:3]
  %4 = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @.str1, i32 %tmp.2) nounwind, !dbg !77 ; [#uses=0 type=i32] [debug line = 52:2]
