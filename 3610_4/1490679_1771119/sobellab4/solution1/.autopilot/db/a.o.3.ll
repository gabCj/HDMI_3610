; ModuleID = 'X:/Bureau/3610_4/1490679_1771119/sobellab4/solution1/.autopilot/db/a.o.3.bc'
...
; <label>:2                                       ; preds = %1
  ...
  %tmp_2 = call i32 (...)* @_ssdm_op_SpecRegionBegin([4 x i8]* @p_str1) nounwind, !dbg !45 ; [#uses=1 type=i32] [debug line = 45:45]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str) nounwind, !dbg !47 ; [debug line = 46:1]
  %tmp_1 = zext i21 %i to i64, !dbg !48           ; [#uses=2 type=i64] [debug line = 47:28]
  %inter_pix_addr = getelementptr [2073600 x i8]* %inter_pix, i64 0, i64 %tmp_1, !dbg !48 ; [#uses=1 type=i8*] [debug line = 47:28]
  ...
  %out_pix_addr = getelementptr [2073600 x i32]* %out_pix, i64 0, i64 %tmp_1, !dbg !67 ; [#uses=1 type=i32*] [debug line = 51:3]
  store i32 %fourWide, i32* %out_pix_addr, align 4, !dbg !67 ; [debug line = 51:3]
  %empty_2 = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @p_str1, i32 %tmp_2) nounwind, !dbg !68 ; [#uses=0 type=i32] [debug line = 52:2]
...
!24 = metadata !{i32 786473, metadata !"SobelLab4/Sobel.cpp", metadata !"X:\5CBureau\5C3610_4\5C1490679_1771119", null} ; [ DW_TAG_file_type ]
