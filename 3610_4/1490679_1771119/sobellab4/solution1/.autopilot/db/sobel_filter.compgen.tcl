...
set ID 5
set MemName sobel_filter_supebkb
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler sobel_filter_gmem0_m_axi
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler sobel_filter_gmem1_m_axi
}
